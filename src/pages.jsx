  ...
  <section className="hero">
    <div className="hero-inner">
      ...
      <div className="cta-row">
        <Link className="btn btn-primary" to="/work">Research <Arrow /></Link>
        {PROFILE.cv && (
...
const ConnectPanel = () => (
  <Reveal>
    <div className="connect">
      ...
      <p>
        For collaborations, leadership initiatives, or opportunities—or simply to discuss public speaking, policy, research, or community impact—I'd love to connect.
      </p>
      <div className="cta-row">
  ...
  return (
    <>
      ...
      <section className="section">
        <SectionHead title="Awards & Recognitions" eyebrow="Research · Competition · Academic" />
      ...
      <section className="section">
        ...
        <MoreLink to="/volunteering">All leadership and service</MoreLink>
      </section>
...
export function About() {
  ...
  return (
    <section className="section">
      <PageHead title="About" eyebrow="Mayoor School · Class of 2027" />
      ...
      <SubHead title="Education" eyebrow="Noida, Uttar Pradesh" />
      <div className="stack">
        {EDUCATION.map((e, i) => (
      ...
      <SubHead title="Standardized tests" />
      <div className="stack">
        {TEST_SCORES.map((s, i) => (
          <Reveal key={s.exam} delay={i * 70}><ScoreCard s={s} /></Reveal>
        ))}
      </div>
    </section>
  );
...
export function Work() {
  ...
  return (
    <section className="section">
      <PageHead title="Work Experience" eyebrow="BEYOND THE CLASSROOM" />
      <div className="grid-2">
        {EXPERIENCE.map((e, i) => (
...
export function Projects() {
  ...
  return (
    <section className="section">
      <PageHead title="Featured Projects" eyebrow="Research · Literature" />
      <div className="grid-2">
        {PROJECTS.map((p, i) => (
...
export function Publications() {
  ...
  return (
    <section className="section">
      <PageHead title="Articles & Publications" eyebrow="Literature · Writing" />
      <div className="row-list">
        {ARTICLES.map((a, i) => (
          <Reveal key={a.title} delay={i * 60}><ArticleRow a={a} /></Reveal>
        ))}
...
export function Volunteering() {
  usePageMeta(`Leadership & Service | ${SITE}`, "Founding a machine learning club, teaching summer band, and community volunteering.");
  return (
    <section className="section">
      <PageHead title="Leadership & Service" eyebrow="Community · Mentoring · Volunteering" />
      <Reveal>
        <div className="vol-panel">
          <div className="vol-stats">
            {VOLUNTEER.stats.map((s) => (
...
export function Sports() {
  usePageMeta(`Voice & Diplomacy | ${SITE}`, "Marching band, saxophone ensemble, concert band, hackathons, and game jams.");
  return (
    <section className="section">
      <PageHead title="Voice & Diplomacy" eyebrow="Debates · Quizzes · Competitions" />
